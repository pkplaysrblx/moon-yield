...
if not IY_LOADED then
	LoadUrl("https://github.com/pkplaysrblx/moon-yield/raw/refs/heads/main/script.lua")
	wait(0.75)
end
...
local ann = "This is unofficial and this is so you can add more plugins. I do not own this. Infinite Store Discord: discord.gg/VwCGhNu9Rb"
local _UserSettings = {
...
if IS_LOADED then
	...
	if _UserSettings.NoNotifications == false then
		notify(
			"Infinite Store",
			"Infinite Store is already executed, a button can be found to open it in Moon Yield's Settings",
			5
		)
	end
...
local InfStoreBtn = makeSettingsButton("Infinite Store", "rbxassetid://138713620011250")
InfStoreBtn.Position = UDim2.new(0, 5, 0, 235)
InfStoreBtn.Size = UDim2.new(1, -10, 0, 25)
InfStoreBtn.Name = "InfiniteStore"
...
if _UserSettings.StartMinimized == true then
	...
	if _UserSettings.NoNotifications == false then
		notify(
			"Infinite Store",
			"Start Minimized is turned on, Infinite Store can be opened inside of Moon Yield's Settings"
		)
	end
else
...
List1.RichText = true
List1.Text = "• <b>Sick Plugins</b> For Moon Yield"
...
List2.RichText = true
List2.Text = "• Definitely <b>0</b> Bugs"
...
mainFrame.TopBar.Title.Text = ("Infinite Store x Moon Yield v" .. IS_Settings["Version"])
...
local guiSettings = {
	...
	["No Notifications"] = {
		...
		["Description"] = "Infinite Store will not give you Moon Yield notifications.",
		["Function"] = function()
